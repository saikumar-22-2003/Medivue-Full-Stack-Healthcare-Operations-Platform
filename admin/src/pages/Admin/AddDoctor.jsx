...
const AddDoctor = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            {/* <div className='bg-white px-8 pt-8 pb-16 border rounded w-full max-w-4xl'> */}
                <div className='flex items-center gap-4 mb-8 text-gray-500'>
                    <label htmlFor="doc-img">
                        <img className='w-16 bg-gray-100 rounded-full cursor-pointer' src={docImg ? URL.createObjectURL(docImg) : assets.upload_icon} alt="" />
                    </label>
                ...
                <button type='submit' disabled={loading} className='bg-primary px-10 py-3 mt-4 text-white rounded-full disabled:opacity-50'>
